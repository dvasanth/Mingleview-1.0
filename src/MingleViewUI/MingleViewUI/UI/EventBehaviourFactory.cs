...
namespace MingleView.UI
{
    ...
    //Participant View -> Listbox item Context menu routing
    public static class ControlBehaviours
    {
        public static readonly DependencyProperty ContextMenuOpening = EventBehaviourFactory.CreateCommandExecutionEventBehaviour(
            Control.ContextMenuOpeningEvent,
            "ContextMenuOpening",
            typeof(ControlBehaviours));

        public static void SetContextMenuOpening(Control o, ICommand command)
        {
            o.SetValue(ContextMenuOpening, command);
        }

        public static void GetContextMenuOpening(Control o)
        {
            o.GetValue(ContextMenuOpening);
        }
    }
}
